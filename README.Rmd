...
- `M`: A 200x2000 matrix of mediators generated using the compound symmetry covariance structure to introduce high correlation among the        mediators. Only the first 8 mediators are active/significant.
...
```
Our method identifies all 8 active mediators `M[, 1],M[,2] M[,3], M[,4], M[,5], M[,6], M[,7], M[,8]`
